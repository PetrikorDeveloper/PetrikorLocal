...
add_filter('single_template', function ($single) {
    ...
    if ($post->post_type === 'case_studies') {
        if ($post->ID == 3122) {
            return get_stylesheet_directory() . '/single-case_studies-3122.php';
        }
        if ($post->ID == 3120) {
            return get_stylesheet_directory() . '/single-case_studies-3120.php';
        }
        if ($post->ID == 3098) {
            return get_stylesheet_directory() . '/single-case_studies-3098.php';
        }
    }
